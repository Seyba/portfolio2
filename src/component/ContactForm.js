    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form>
        <div className="px-2">
          ...
          <div>
            <label htmlFor="message" className="block text-sm font-medium leading-6 text-gray-100">
              Message
            </label>
            <div className="mt-2">
              <textarea
          ...
          <div className="mt-4">
            <button
              type="submit"
              className="flex w-full justify-center rounded-sm bg-zinc-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Send Request
            </button>
          </div>
